...
public class DailyAgendaPanelTest {
    ...
    public void filterTest() {
        ...
        GymClass class1 = new GymClass(new CalendarDate(new Date(2000, 1, 1)), trainer1);
        class1.setRoom(GymRoom.ROOM2);
        classes.add(class1);
        GymClass class2 = new GymClass(new CalendarDate(new Date()), trainer1);
        class2.setRoom(GymRoom.ROOM3);
        classes.add(class2);
        GymClass class3 = new GymClass(new CalendarDate(new Date()), trainer1);
        class3.setRoom(GymRoom.ROOM4);
        classes.add(class3);
        GymClass class4 = new GymClass(new CalendarDate(new Date(2000, 4, 1)), trainer1);
