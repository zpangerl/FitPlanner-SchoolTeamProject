...
public class GymClassEditDialog extends JDialog {
    ...
    public GymClassEditDialog(Frame frame, String title) {
    ...
    void jbInit() throws Exception {
        ...
        okB.setText(Local.getString("Submit"));
        ...
        header.setText(Local.getString("Edit Class"));
